...
class AsyncGetTeacherFood extends AsyncTask<Void, Void, LinkedList<TreeMap<String, String[]>>> {
    ...
    public AsyncGetTeacherFood(AsyncCallBack callback, String token, BaseCompatActivity baseCompatActivity) {
    ...
    protected LinkedList<TreeMap<String, String[]>> doInBackground(Void... voids) {
        ...
        return data.getTeacherFood(token, baseCompatActivity);
    }
}
